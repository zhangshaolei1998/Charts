...
\begin{figure}[!tbp]
  ...
  \caption{Slice analysis of the four agent settings on \probe{} ($n{=}200$).
    Markers show slice means; the right column gives $\Delta$ Chart$-$Text.}
...
\begin{table}[t]
	...
	\begin{minipage}[t]{0.28\textwidth}
		\centering
		\captionsetup{width=\linewidth,font=small,justification=centering,singlelinecheck=false}%
		\captionof{table}{Interface ablation.}
	...
	\begin{minipage}[t]{0.58\textwidth}
		...
		{\setlength{\tabcolsep}{2.6pt}%
			...
			\scriptsize
			\begin{tabular}{@{}lS[table-format=2.1]S[table-format=3.0]S[table-format=1.0]S[table-format=3.0]S[table-format=1.1]S[table-format=5.0]@{}}
				\toprule
				\multirow{2}{*}[-0.15em]{Backbone} &
				\multicolumn{1}{c}{\multirow{2}{*}[-0.15em]{Score}} &
				...
				\midrule
				Claude Opus 5 & 83.1 & 43 & 0 & 157 & 3.9 & 17401 \\
				Claude Sonnet 5 & 79.2 & 102 & 0 & 98 & 4.0 & 18724 \\
				GPT-5.6 Luna & 76.2 & 198 & 0 & 2 & 3.1 & 6835 \\
				GPT-5.6 Sol & 77.6 & 198 & 0 & 2 & 2.9 & 6392 \\
				DeepSeek V4.1 Flash & 80.2 & 143 & 0 & 57 & 6.2 & 30051 \\
				HY3 & 73.1 & 198 & 0 & 2 & 3.8 & 7725 \\
				\bottomrule
		\end{tabular}}
	\end{minipage}\hfill
	\vspace{-10pt}
